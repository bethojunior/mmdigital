...
elementProperty.addEventInElement('.open-about-service','onclick',function (){
    $('ul.tabs').tabs('select_tab', 'pageAbout');
})

elementProperty.addEventInElement('.open-blog-service','onclick',function (){
    $('ul.tabs').tabs('select_tab', 'pageBlog');
})

elementProperty.addEventInElement('.open-agenda-service','onclick',function (){
    $('ul.tabs').tabs('select_tab', 'pageAgenda');
})
